...
from routers import module1, module2, module3, module4, module5, module6, simple_report, knowledge, calendar
...
app.include_router(simple_report.router, prefix="/api/simple_report", tags=["簡單報告"])
